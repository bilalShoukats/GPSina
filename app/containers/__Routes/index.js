...
// dashboard
import DashboardScreen from "containers/Dashboard/DashboardScreen/Loadable";
...
const Routes = props => (
  <Switch>
    ...
    <PrivateRoute exact path="/viewDevices" component={ViewDeviceScreen} />
    {/* Employee Links */}
    ...
    <PrivateRoute exact path={`/addFence/:item`} component={FenceScreen} />
