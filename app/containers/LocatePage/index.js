...
export function PoiPage(props) {
    const [gsmStatus, setGsmStatus] = useState(0);
    const [marker, setMarker] = useState(true);
    const [carWidth, setCarWidth] = useState(30);
    ...
    const handleApiLoaded = async (map, google) => {
    ...
    const calculateHeading = (point, marker) => {
    ...
    const toggleTrafficLayer = (trafficLayer, map) => {
