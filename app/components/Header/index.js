...
import { Button, ButtonGroup, ClickAwayListener, Grid, Grow, MenuItem, MenuList, Paper, Popper, Typography } from '@material-ui/core';
          ...
          <Button className={classes.btnStyle} size="small">
            ...
            <Grid container direction="column">
              <Grid item>
                ...
                <Popper style={{ zIndex: 99 }} open={open} placement="bottom-end" anchorEl={anchorRef.current} role={undefined} transition disablePortal>
                      ...
                      <ClickAwayListener onClickAway={handleClose}>
                        <MenuList id="split-button-menu">
                          <MenuItem
                            ...
                            onClick={(event) => props.onPressAddPoi()}
                          >
